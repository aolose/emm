...
<Card title="Analysis">
  <button class="icon i-refresh" slot="btn" on:click={getD}></button>
  <div class="v">
    <div class="bn">
      <span>last: </span>
      {#each n as a,index}
...
<style lang="scss">
  ...
  canvas {
    position: absolute;
    background: linear-gradient(0deg, rgba(100, 100, 100, .5) 0, transparent 1px), linear-gradient(90deg, rgba(100, 100, 100, .5) 0, transparent 1px) 18px 10px;
